...
public class TC_ProductPageTest extends BaseClass {
	...
	public void verifyAddToWishlistWithoutLogin() throws IOException {
		...
		prodPage.clickOnaddToCompareButton();

		/*
		 * prodPage.clickOnAddToWishList();
		 * 
		 * String actualAlertMsg = prodPage.getTextOfAlertForWishList(); String
		 * expectedAlertMsg = "You must be logged in to manage your wishlist.";
		 * 
